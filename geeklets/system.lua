...
local operatingSystemVersion = host.operatingSystemVersion()
local hostDetails = styledtext.new(host.localizedName() .. " | macOS " .. operatingSystemVersion.major .. "." .. operatingSystemVersion.minor .. "." .. operatingSystemVersion.patch .. "\n", {
    font = baseFont,
    color = { list = "ansiTerminalColors", name = "fgWhite"   }
})
...
batteryGuage = batteryGuage .. styledtext.new(" " .. tostring(avail) .. "% charged, " .. tostring(cur_charge) .. "(mAh) Remain\n", { font = baseFont, color = tailColor })
 ...
 -- be lazy
return (hostDetails .. cpuGuage .. ramGuage .. batteryGuage):sub(1, -2)
